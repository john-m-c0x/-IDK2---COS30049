...
# Load datasets
set1 = pd.read_csv('C:/ar/sem 2/ctip/ass2/visualisation/datasets/cleaned_water_potability.xls')
set2 = pd.read_csv('C:/ar/sem 2/ctip/ass2/visualisation/datasets/cleaned_water_potability02.xls')
